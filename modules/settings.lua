ShaguPlates:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Overwrite If Unit Is Attacking Someone On The Watchlist"], C.nameplates, "ccombatthreatwatchlist", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Unit Is Attacking Someone On The Watchlist Color"], C.nameplates, "combatthreatwatchlist", "color")
      ...
      CreateConfig(U["nameplates"], T["Watchlist"], C.nameplates, "combatwatchlist", "list")
