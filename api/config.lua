...
function ShaguPlates:LoadConfig()
  ...
  ShaguPlates:UpdateConfig("global",     nil,           "font_unit_name",   "Interface\\AddOns\\ShaguPlates\\fonts\\Myriad-Pro.ttf")
  ShaguPlates:UpdateConfig("global",     nil,           "font_combat",      "Interface\\AddOns\\ShaguPlates\\fonts\\Continuum.ttf")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "namefightcolor",   "1")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "ccombatthreatwatchlist",   "0")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "combatthreatwatchlist",    ".7,.5,.2,1")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "combatwatchlist",          "")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffoffset",     "4")
